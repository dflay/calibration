...
class FileReader:
   def __init__(self):
      ...
      self.List2 = []
   #_______________________________________________________________________ 
   def ReadCSV_1col(self,fileName,field):
      csvFile = csv.DictReader( open(fileName) )
      for row in csvFile:
         self.List1.append(row[field]) 
   #_______________________________________________________________________ 
   def ReadCSV_2col(self,fileName,field1,field2):
      csvFile = csv.DictReader( open(fileName) )
      for row in csvFile:
         self.List1.append(row[field1]) 
         self.List2.append(row[field2]) 
